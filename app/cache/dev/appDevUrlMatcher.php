...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            // admin_erase
            if (preg_match('#^/admin/(?P<id>[^/]++)/erase$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_admin_erase;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_erase')), array (  '_controller' => 'Miw\\PracticaBundle\\Controller\\UserController::eraseAction',));
            }
            not_admin_erase:
        ...
        if (0 === strpos($pathinfo, '/contacto')) {
            ...
            // contacto_erase
            if (preg_match('#^/contacto/(?P<id>[^/]++)/erase$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_contacto_erase;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'contacto_erase')), array (  '_controller' => 'Miw\\PracticaBundle\\Controller\\ContactoController::eraseAction',));
            }
            not_contacto_erase:
            ...
            // contacto_erase_multiple
            if ($pathinfo === '/contacto/erase_multiple') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_contacto_erase_multiple;
                }

                return array (  '_controller' => 'Miw\\PracticaBundle\\Controller\\ContactoController::eraseMultipleAction',  '_route' => 'contacto_erase_multiple',);
            }
            not_contacto_erase_multiple:

            // contacto_delete_multiple
            if ($pathinfo === '/contacto/delete_multiple') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_contacto_delete_multiple;
                }

                return array (  '_controller' => 'Miw\\PracticaBundle\\Controller\\ContactoController::deleteMultipleAction',  '_route' => 'contacto_delete_multiple',);
            }
            not_contacto_delete_multiple:
